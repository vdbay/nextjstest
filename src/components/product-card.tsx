    ...
    <div className="bg-[#5c4c1e] rounded-xl overflow-hidden relative">
      ...
      <div className="p-6">
        ...
        <div className="flex flex-col">
          <span className="text-[#e9c978] font-bold text-xl">
            Rp. {product.price}
          </span>
        ...
        <div className="mt-4 flex items-center gap-2">
          <Button className="bg-[#e9c978] hover:bg-[#d4b76a] text-black rounded-full flex-1">
            BUY NOW!
          </Button>
          <Button
            variant="outline"
            className="border-[#e9c978] text-[#e9c978] rounded-full p-2"
          >
