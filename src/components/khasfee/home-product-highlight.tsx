  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 m-6 gap-6">
      <div className="flex flex-col gap-6">
        ...
        <div className="flex flex-grow gap-6 text-2xl">
          ...
          deserunt quos veniam! Lorem ipsum dolor sit amet consectetur
          adipisicing elit. Optio, quaerat perspiciatis nisi quam nemo rem nobis
          delectus.
        </div>
