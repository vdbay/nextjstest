      ...
      <div className="grid grid-cols-1 md:grid-cols-6 px-16 py-8 gap-x-8 gap-y-8 md:gap-y-0 bg-gold-khasfee">
        ...
        <div className="flex flex-col">
          ...
          <div className="flex flex-col gap-3">
            <div className=" text-black opacity-50">Home</div>
            <div className=" text-black opacity-50">About Us</div>
            <div className=" text-black opacity-50">Products</div>
            <div className=" text-black opacity-50">Contact</div>
          </div>
        </div>
        <div className="flex flex-col">
          <div className="mb-6">Customer Care</div>
          <div className="flex flex-col gap-3 ">
            <div className=" text-black opacity-50">FAQ</div>
            <div className=" text-black opacity-50">Shipping & Returns</div>
            <div className=" text-black opacity-50">How to Order</div>
            <div className=" text-black opacity-50">Privacy Policy</div>
            <div className=" text-black opacity-50">Terms & Conditions</div>
          </div>
        </div>
        <div className="flex flex-col">
          ...
          <div className="flex flex-col gap-3">
            ...
            <div className=" text-black opacity-50">Join KHASFEELIATE</div>
          </div>
        </div>
        <div className="flex flex-col">
